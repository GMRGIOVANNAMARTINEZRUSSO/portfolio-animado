                ...
                <div className="-my-6">
                    {dataAboutPage.map((data) => (
                        <div key={data.id}
                            ...
                            <h3 className="mb-l text-2xl font-bold sm:mb-0"> {data.title}  </h3>
                            <div className="flex flex-col sm:flex-row items-start mb-1 
                                ...
                                <time className="sm:absolute left-0 translate-y-0.5 inline-flex items-center justify-center  text-xs font-semibold uppercase w-20 h-6 mb-0 text-emerald-600 bg-emerald-100 rounded-full">{data.date}</time>
